...
static int StressCondition(Translator *tr, PHONEME_LIST *plist, int condition, int control)
{//========================================================================================
// condition:
...
static int InterpretCondition(Translator *tr, int control, PHONEME_LIST *plist, USHORT *p_prog, WORD_PH_DATA *worddata)
{//========================================================================================================================
	int which;
	int ix;
	unsigned int data;
	...
	if(instn2 < 14)
	{
		...
		if(instn2 < 7)
		{
			...
			if(phoneme_tab[data]->mnemonic == ph->mnemonic)
				return 1;
